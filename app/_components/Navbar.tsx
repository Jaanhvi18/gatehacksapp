            ...
            <div className="max-w-screen-xl flex flex-wrap items-center justify-end mx-auto p-4">
                ...
                <div className="hidden w-full md:block md:w-auto" id="navbar-default">
                    <ul className="font-medium flex flex-col md:flex-row items-center max-md:items-start p-4 md:p-0 mt-4 border border-gray-100 md:mt-0 md:border-0 max-md:bg-[#1d232d]">
                        <li className="mx-2">
                            <Link href={"/"} className="max-md:text-white block py-2 pl-3 pr-4 text-gray-900 hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0  md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Home</Link>
                        </li>
                        <li className="mx-2">
                        ...
                        <li className="mx-2">
                            <Link href={"/actions"} className="max-md:text-white block py-2 pl-3 pr-4 text-gray-900 hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0  md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Action</Link>
                        </li>
                    </ul>
                </div>
            </div>
